            ...
            <div class="card-body">
              <form action="{{ route('admin.autocolumn.update', $autocolumn->id ) }}" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <a href="{{ route('admin.cars.show', $autocolumn->car->id ) }}" class="btn btn-info"><i class="fa fa-eye"></i> {{ $car->awtoulagyn_kysymy }} - {{ $car->awtoulagyn_gornushi }} - ( {{ $car->awtoulogyn_shahsy_belgisi }} ) ulagyň maglumatlaryna gir</a>
                    </div>
                  </div>
